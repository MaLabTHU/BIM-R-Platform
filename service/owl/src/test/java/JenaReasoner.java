...
//        final String ont = "http://protege.cim3.net/file/pub/ontologies/koala/koala.owl#";
        final String ont = JenaReasoner.class.getResource("cost.rl.owl").getFile();
//        final String ns = "http://protege.stanford.edu/plugins/owl/owl-library/koala.owl#";
        final String ns = "http://www.semanticweb.org/luciferz2012/ontologies/2016/10/untitled-ontology-17#";
        ...
        // print superclasses
        final Resource c = model.getResource(ns + "Wall");
...
//        final OntClass c = model.getOntClass(ns + "MaleStudentWith3Daughters");
        final OntClass c = model.getOntClass(ns + "Wall");
